...
@router.get("/cer/communities/{cer_id}/billing/statements", response_model=List[BillingStatementResponse])
...
@router.get("/cer/communities/{cer_id}/billing/member-balances", response_model=List[MemberBalanceResponse])
...
@router.get("/cer/communities/{cer_id}/billing/transactions", response_model=List[BillingTransactionResponse])
...
@router.post("/cer/communities/{cer_id}/billing/transactions", response_model=BillingTransactionResponse, status_code=status.HTTP_201_CREATED)
...
@router.post("/cer/communities/{cer_id}/billing/settle", response_model=SettlementCalculationResponse)
...
@router.get("/cer/communities/{cer_id}/billing/settlements", response_model=List[SettlementResponse])
async def list_settlements(
    ...
    try:
        ...
        ).order_by(Settlement.settlement_date.desc()).offset(skip).limit(limit).all()
...
@router.get("/cer/communities/{cer_id}/billing/settlements/{settlement_id}", response_model=SettlementResponse)
