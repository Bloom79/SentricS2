...
class ComplianceRequirement(BaseModel):
    ...
    # Relationships
    plant = relationship("Plant", back_populates="compliance_requirements", foreign_keys="[ComplianceRequirement.plant_id]")
...
class ComplianceRecord(BaseModel):
    ...
    # Status
    status = Column(Enum(ComplianceStatusEnum), nullable=False, default=ComplianceStatusEnum.PENDING)
