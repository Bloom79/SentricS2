...
from sqlalchemy import Column, Integer, Float, DateTime, String, ForeignKey, JSON, Enum, Text, Boolean, Index
...
class BillingStatement(BaseModel):
    ...
    transactions = relationship("BillingTransaction", back_populates="statement", cascade="all, delete-orphan", lazy="select")
...
class Invoice(BaseModel):
    ...
    statement = relationship("BillingStatement", back_populates="invoice", uselist=False, lazy="select")
    transactions = relationship("BillingTransaction", back_populates="invoice", cascade="all, delete-orphan", lazy="select")
