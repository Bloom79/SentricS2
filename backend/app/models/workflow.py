...
class WorkflowPhase(BaseModel):
    ...
    required_documents = Column(
        JSON, default=list
    )  # ["RID Application Form", "Plant Technical Specifications", ...]

    # Form fields/data structure for official forms
    official_form_fields = Column(
        JSON, default=dict
    )  # {"produttore_denominazione": "Denominazione", ...}
    ...
    checklist_items = Column(
        JSON, default=list
    )  # ["Verifica firma tecnico", "Controllo completezza", ...]
