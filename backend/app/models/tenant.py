...
class Tenant(Base, TimestampMixin):
    ...
    # Relationships
    users = relationship("User", back_populates="tenant", foreign_keys="[User.tenant_id]", primaryjoin="Tenant.id == foreign(User.tenant_id)")
    plants = relationship("Plant", back_populates="tenant", foreign_keys="[Plant.tenant_id]", primaryjoin="Tenant.id == foreign(Plant.tenant_id)")
