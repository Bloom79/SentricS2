...
class WorkflowTemplate(BaseModel):
    ...
    recurrence = Column(Enum(WorkflowTemplateRecurrenceEnum), default=WorkflowTemplateRecurrenceEnum.ONE_TIME)
    ...
    # Relationships
    phases = relationship("WorkflowTemplatePhase", back_populates="template", cascade="all, delete-orphan", order_by="WorkflowTemplatePhase.order")
