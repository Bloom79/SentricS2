...
class PlantService:
    ...
    @staticmethod
    def create_plant(db: Session, plant_data: PlantCreate, tenant_id: str, user_id: int) -> Plant:
        """Create a new plant"""
        try:
    ...
    @staticmethod
    def get_plant(
        db: Session, plant_id: int, tenant_id: str, include_relations: bool = True
    ) -> Optional[Plant]:
        ...
        if include_relations:
            query = query.options(joinedload(Plant.cer), selectinload(Plant.assets))
    ...
    def list_plants(
        ...
        query = (
            ...
            .options(selectinload(Plant.cer))  # Eager load CER to prevent N+1
        )
    ...
    @staticmethod
    def update_plant(
        db: Session, plant_id: int, plant_data: PlantUpdate, tenant_id: str, user_id: int
    ) -> Optional[Plant]:
        """Update plant"""
    ...
    @staticmethod
    def delete_plant(db: Session, plant_id: int, tenant_id: str, user_id: int) -> bool:
    ...
    @staticmethod
    def get_plant_stats(db: Session, plant_id: int, tenant_id: str) -> Dict[str, Any]:
